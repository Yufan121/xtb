...
pure subroutine dshellPolyPerAtom(iPoly,jPoly,iPolyPerAtom,jPolyPerAtom,iRad,jRad,rab2,xyz1,xyz2,rf,dxyz)
   !$acc routine seq
   ...
   k1=(iPoly + iPolyPerAtom)*0.01_wp   ! Done
   k2=(jPoly + jPolyPerAtom)*0.01_wp   ! Done
...
end subroutine dshellPolyPerAtom
